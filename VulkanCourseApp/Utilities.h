...
struct SwapChainDetails {
	...
	std::vector<VkPresentModeKHR> presentationModes;		// How images should be presentated to screen
};
...
static void copyImageBuffer(VkDevice device, VkQueue transferQueue, VkCommandPool transferCommandPool, VkBuffer srcBuffer, VkImage image, uint32_t width, uint32_t height)
{
	...
	imageRegion.imageOffset = { 0, 0, 0 };										// Offset into image (as oppose to raw data in buffer data offset)
